...
modelo_dsa_final = joblib.load('model.pkl')
...
def predict():
    ...
    return render_template('demo.html', prediction_text = f'Previsão do Modelo (1 - Cliente Fará Outra Compra / 0 - Cliente Não Fará Outra Compra): {prediction[0]}')
